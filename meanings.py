libs = ["Today, / every / student has a computer small enough to fit into his <noun>. He can solve any math problem by simply pushing the computer’s little <plno>. Computers can add, multiply, divide, and <verb>. They can also <verb> better than a human. Some computers are <bodp>. Others have / <adje> screen that shows all kinds of <plno> and <adje> figures.",
        ...
        "Last week was my birthday. We went to my Grandma’s house and had <food> for supper. After that, we all sat in the <room> to open my presents. The first gift was from <name>, and it was / <noun>. The next gift was from <name> and it was / <adje> <noun>. The gift after that was / <noun>. I pretended to be happy, but I already had one of those. All of a sudden, I heard a strange noise. The noise was <adje> and I couldn’t tell where it was coming from. I looked around the room. I stood up and walked <adve> to the <room>. I looked in the <noun>. I looked under the <noun>. I even looked in the <noun>. I found nothing! I realised that everyone in the other room was laughing! I asked my friend <name>. ‘What’s going on?’ I asked my other friend <name>, and they just laughed. I asked <name> but they <verb> around the room. I heard the noise again. Suddenly, it occurred to me that the noise was coming from one of the presents! I opened the gift and inside the box was a baby <anim>! I was surprised.",
        "Our <plno> are packed for a hike in the <adje> Mountains! We are carrying a picnic lunch with <food> and <food> on our <bodp>, and I have a <noun> for <ving> photos. We will <verb> past meadows filled with <colo> and <colo> flowers, and pass a <adje> waterfall that sounds like / <noun>. Many animals live in the mountains, like the <adje> <anim> and <adje> <anim>. It’s fun to <verb> them but important to be safe and keep / <adje> distance. The higher we <verb>, the smaller the wildflower meadow and waterfall appear; we may even see <noun> still on the ground from last winter."]
#libs array stores all the mad libs scripts
types = ["noun", "plno", "verb", "ving", "veed", "adje", "food", "liqu", "colo", "anim", "anis", "room",
         "city", "bodp", "name", "cele", "genr", "inst", "song", "danc", "numb", "clot", "adve"]
...
questions = ["Enter a noun: ", "Enter a plural noun: ", "Enter a verb: ", "Enter a verb ending in -ing: ",
             ...
             "Enter a dance style or type: ", "Enter a number: ", "Enter an item of  clothing: ", "Enter an adverb: "]
